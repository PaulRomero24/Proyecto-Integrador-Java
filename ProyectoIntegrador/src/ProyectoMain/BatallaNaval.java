        ...
        while (!tablero.juegoFinalizado() && disparosRestantes > 0) {
            ...
            if (disparosValidos > 0 && disparosValidos % 5 == 0) {
                if (input.equalsIgnoreCase("salir") || 
                    ...
                    System.out.println("\n⏹️  Te has rendido tras " + disparosValidos + " disparos válidos.");
            ...
            if (coords == null) {
                System.out.println("\n⚠️ Formato incorrecto. Usa letra y número (ej: A5).");
                if (disparosValidos > 0 && disparosValidos % 5 == 0) {
            ...
            if (!disparoValido) {
                System.out.println("\n⚠️ Ya disparaste ahí o la coordenada es inválida.");
                continue;
            }
